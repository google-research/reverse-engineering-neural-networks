...
"""Build Transformer model and optimizer.

Adapted from flax/examples/lm1b/train.py.
"""
...
def create_optimizer(model, learning_rate, weight_decay):
  # TODO(yuancao): Make beta params if needed.
